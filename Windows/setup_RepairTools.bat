...
:: AVs
curl.exe --output ClamAV.zip https://www.clamav.net/downloads/production/clamav-1.3.1.win.x64.zip
...
:: Batch Scripts
curl.exe --output admin_check_for_corruption.bat https://raw.githubusercontent.com/Batcastle/SysAdminScripts/master/Windows/admin_check_for_corruption.bat
curl.exe --output admin_clam_scan.bat https://raw.githubusercontent.com/Batcastle/SysAdminScripts/master/Windows/admin_clam_scan.bat
